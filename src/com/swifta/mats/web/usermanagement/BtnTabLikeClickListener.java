...
public class BtnTabLikeClickListener implements Button.ClickListener {
	...
	// No subMenu
	public BtnTabLikeClickListener(boolean isMainMenuItem, boolean hasSubMenu,
			ArrayList<HorizontalLayout> arrLSubTabs,
			ArrayList<BtnTabLike> arrLTabBtns,

			HorizontalLayout cSubMenu, Object udm, String strTbName,
			String strUID, boolean hasOp, boolean boolEditStatus,
			String[] arrSessions, String[] arrSessionVars) {
	...
	public Window getWarningPopWindow() {
		...
		Label lbUnsavedDataMsg = new Label(
				"All unsaved changes on this page will be lost. \rStay on this Page?");
		...
		cPopupMsg.setComponentAlignment(cUnsavedDataMsg,
	...
	private void showHideSubMenu() {
		if (arrLSubTabs != null) {
			...
			/*
			 * Next line is important for only one reason... 1. Ensure that
			 * child Menu does not hide its Parent
			 */
