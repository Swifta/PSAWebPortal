...
public class UserDetailsModule{
	...
	public FormLayout getDetailsForm(String strTbName, String strUID){
		Map<String, String[]> mappedData = getUDetails(strTbName, strUID);
		FormLayout frmLayout;
		if(mappedData.size() == 0){
			frmLayout = new FormLayout();
			frmLayout.addComponent(new Label(" NO Data Available!"));
		}else{
			frmLayout = setDetailsForm(mappedData);
		}
	...
	//private FormLayout getDetailsForm(String strTbName[], String[] strUID, String[] arrTfCaptions, final String[] arrTfVals, String[] arrOptCaptions, String[] arrOptSelVals, String[] arrComboCaptions, String[] arrComboSelVals, String[] arrDfCaptions, String[] arrDfVals){
