...
public VerticalLayout getMenu(boolean boolAddHeaderStatus, boolean boolEditStatus, boolean hasOp){
	...
	String[] arrSessions = new String[]{
			WorkSpaceManageProfile.SESSION_WSMP_CUR_ACTION,WorkSpaceManageProfile.SESSION_UDM_IS_LOG};
	...
	btnPersonal.addClickListener(new BtnTabLikeClickListener(
			...
			new String[]{WorkSpaceManageProfile.SESSION_VAR_WSMP_PERSONAL, null}));
	...
	btnAccount.addClickListener(new BtnTabLikeClickListener(
			...
			boolEditStatus,
			arrSessions,
			new String[]{WorkSpaceManageProfile.SESSION_VAR_WSMP_AUTH, null}));
...
String[] arrSessions = new String[]{
		WorkSpaceManageProfile.SESSION_UDM_TABLE_LOG, WorkSpaceManageProfile.SESSION_UDM_IS_LOG};
...
btnAct.addClickListener(new BtnTabLikeClickListener(
		...
		boolEditStatus,
		arrSessions,
		new String[]{WorkSpaceManageProfile.SESSION_VAR_WSMP_ACT_LOG, WorkSpaceManageProfile.SESSION_VAR_UDM_LOG}));
...
btnAcc.addClickListener(new BtnTabLikeClickListener(
		...
		boolEditStatus,
		arrSessions,
		new String[]{WorkSpaceManageProfile.SESSION_VAR_WSMP_ACC_LOG, WorkSpaceManageProfile.SESSION_VAR_UDM_LOG}));
...
btnAddUser.addClickListener(new BtnTabLikeClickListener(
		...
		hasOp,
		boolEditStatus,
		new String[]{WorkSpaceManageProfile.SESSION_UDM_IS_LOG},
		new String[]{WorkSpaceManageProfile.SESSION_VAR_UDM_LOG}));

		UI.getCurrent().getSession().setAttribute(WorkSpaceManageProfile.SESSION_UDM_LOG, null);
		UI.getCurrent().getSession().setAttribute(WorkSpaceManageProfile.SESSION_UDM_TABLE_LOG, WorkSpaceManageProfile.SESSION_VAR_WSMP_ACT_LOG);
