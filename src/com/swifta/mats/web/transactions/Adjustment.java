	...
	public FormLayout AddAdjustmentPanel() {
		...
		Test.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				String email = "daopeyemi@swifta.com";
				String msisdn = "08089898989";
				int profileid = 11;
				String securityQuest = "Hello Africa";
				String securityAns = "How r u";
				String termscondition = "gdeyu";
				String username = "daopeyemi";
				int countryid = 165;
				Date dateofBirth = new Date();
				String employer = "Swifta";
				String firstname = "Ope";
				String province = "Adekugbe";
				Date Expirydate = new Date();
				String idNumber = "6589688";
				String idType = "Kay";
				...
				String PrimaryMobilenumber = "08056576887";
